...
Resource.create(name: "She Thinks Like a Boss", kind: "book", description: "9 Essential Skills for New Female Leaders in Business and the Workplace. How to Influence Teams Effectively and Combat Imposter Syndrome", url: "https://www.amazon.com/She-Thinks-Like-Boss-Effectively/dp/B095DBDMKC/ref=pd_sbs_5/132-4409980-9797807?pd_rd_w=lpHLH&pf_rd_p=8b76d7a7-ab83-4ddc-a92d-e3e33bfdbf03&pf_rd_r=6DPBJBMD4KEFGPSJJ0BC&pd_rd_r=64d88a6f-de5e-4187-b63b-cc3b309768d9&pd_rd_wg=agsYy&pd_rd_i=B095DBDMKC&psc=1")
...
Resource.create(name: "le wagon Web Development course in ShanghaiShanghai", kind: "course", description: "Change your life, learn to code.", url: "https://www.lewagon.com/shanghai/web-development-course/full-time")
Resource.create(name: "le wagon Data Science course in ShanghaiShanghai", kind: "course", description: "Enter the world of Data Science as a Data Analyst, Data Engineer or Data Scientist", url: "https://www.lewagon.com/shanghai/data-science-course/full-time")
...
Resource.create(name: "How to monetize the curation economy, social communities & online learning", kind: "article", description: "3 startup opportunities for your next venture", url: "https://whizzoe.medium.com/how-to-monetize-the-curation-economy-social-communities-online-learning-61f44e3696ed")
